...
- The live deployment branch is `devin/1778553824-session1-scaffold-auth` (yes, a `devin/` branch is the production branch — not `main`). Railway auto-redeploys on push to that branch; builds typically take 2–3 min.
